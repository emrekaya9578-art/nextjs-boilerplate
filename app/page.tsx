...
// Bu kısım Supabase bağlantını sağlar. 
// Vercel Settings > Environment Variables kısmına eklediysen otomatik çalışır.
...
export default async function Home() {
  // İlanları Supabase'den çekiyoruz
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans text-gray-900">
      ...
      <header className="bg-blue-900 text-white shadow-xl p-5 sticky top-0 z-50">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          <div className="flex flex-col">
            <h1 className="text-3xl font-black tracking-tighter leading-none">🚗 UYGUNARABAM</h1>
            <span className="text-[10px] uppercase tracking-[0.2em] opacity-70 mt-1 font-bold">İkinci Elde Güvenin Adresi</span>
          </div>
          <div className="hidden md:flex gap-6 text-sm font-medium">
            <span className="hover:text-blue-200 cursor-pointer transition">Anasayfa</span>
            <span className="hover:text-blue-200 cursor-pointer transition">İlanlar</span>
            <span className="hover:text-blue-200 cursor-pointer transition">Hakkımızda</span>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-6xl mx-auto p-6">
        ...
        <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-4 border-b pb-6">
          <div>
            <h2 className="text-4xl font-extrabold text-gray-800">Güncel İlanlar</h2>
            <p className="text-gray-500 mt-1">Şu an yayında olan en uygun araçları listeliyorsunuz.</p>
          </div>
        </div>
              ...
              <div className="p-6">
                ...
                <div className="flex flex-col gap-3">
                  <a 
                    ...
                    className="flex items-center justify-center gap-2 w-full bg-green-500 text-white font-black py-4 rounded-2xl hover:bg-green-600 hover:scale-[1.02] active:scale-95 transition-all shadow-md shadow-green-100"
                  >
        ...
        {(!ilanlar || ilanlar.length === 0) && (
          <div className="text-center py-32 bg-white rounded-3xl border-2 border-dashed border-gray-200">
             ...
             <p className="text-gray-400">Yönetim panelinden (Supabase) ilk ilanınızı girdiğinizde burada görünecektir.</p>
          </div>
        )}
      </main>
      ...
      <footer className="bg-gray-900 text-gray-500 text-center p-12 mt-20">
        <div className="max-w-6xl mx-auto flex flex-col items-center">
          <h2 className="text-white text-xl font-black mb-4 tracking-tighter">UYGUNARABAM.COM</h2>
          <p className="max-w-md mx-auto mb-6 text-xs leading-loose">
            Bu platform üzerinden paylaşılan ilanların tüm sorumluluğu ilan sahibine aittir. 
            Güvenli alışveriş için yüz yüze görüşmeyi tercih ediniz.
          </p>
